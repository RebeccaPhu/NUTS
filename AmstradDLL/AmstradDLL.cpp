...
FSDescriptor AmstradFS[] = {
	{
		...
		/* .PUID         = */ FSID_AMSDOS,
		/* .Flags        = */ FSF_Formats_Raw | FSF_Creates_Image | FSF_Formats_Image | FSF_Supports_Spaces | FSF_Supports_Dirs | FSF_FixedSize | FSF_UseSectors | FSF_No_Quick_Format | FSF_Imaging,
		512, 40 * 9 * 512,
		(BYTE *) "DSK"
	},
	{
